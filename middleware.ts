...
function denied(reason: string): NextResponse {
  // Plain static page — NO FileMaker callback of any kind (a bridge/PerformScript
  // call from here was crashing the FileMaker app). Any 401-loop / retry behavior
  // is handled on the FileMaker side per the dev's spec.
